...
struct _R {
  ...
  struct string {
    ...
    struct localizable {
      ...
      /// en translation: Rosmance
      ///
      /// Key: QuickDate
      ///
      /// Locales: en, tr
      var quickDate: RswiftResources.StringResource { .init(key: "QuickDate", tableName: "Localizable", source: source, developmentValue: "Rosmance", comment: nil) }
