    ...
    public class FavoriteUserFragment : Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            try
            {
                ...
                MAdapter.FavItemClick += MAdapterOnFavItemClick;
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                MAdapter = new FavoriteUserAdapter(Activity)
                {
        ...
        private void MAdapterOnFavItemClick(object sender, FavoriteUserAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (item != null)
                {
                    ...
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => RequestsAsync.Favorites.DeleteFavoritesAsync(item.UserData.Id.ToString()) });
